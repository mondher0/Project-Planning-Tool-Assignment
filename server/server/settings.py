...
# Define the BASE_DIR to easily reference the root directory
...
SECRET_KEY = "django-insecure-b=+m$q=j!m_okoks=@o-2(mxro4uxb-+9%3_8z!51w_o-m27_b"
...
DEFAULT_FROM_EMAIL = f"Project-Planning-Tool <{EMAIL_HOST_USER}>"
